...
<div xmlns="http://www.w3.org/1999/xhtml" class="main13" component="$UI/system/components/justep/window/window"
  ...
  <column label="销售数量" name="fRecord" type="Integer" xid="xid10"></column></div> 
  </div>  
  ...
  <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon seach-btn" label="button" xid="button1" icon="icon-ios7-search-strong">
   ...
   <span xid="span1"></span></a></div>  
        <div class="x-titlebar-right reverse"><a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon more" label="button" xid="button10" icon="icon-android-more">
  ...
  <a component="$UI/system/components/justep/button/button" class="btn btn-link" label="免运费" xid="button8">
   ...
   <div class="x-scroll-content" xid="div6"><div component="$UI/system/components/justep/list/list" class="x-list" xid="list1" data="listData" limit="5" bind-click="listClick">
   <ul class="x-list-template" xid="listTemplateUl1">
    <li xid="li1" class="main"><div component="$UI/system/components/bootstrap/row/row" class="row x-list-template grid" xid="row4" style="width:100%;">
   <div class="col col-xs-4" xid="col8" style="height:80px;">
    <img src="" alt="" xid="image2" bind-attr-src='val("fImg")' style="width:90%;" height="100%"></img></div> 
   <div class="col col-xs-8" xid="col9" style="height:80px;">
    <div xid="div11">
     <span class="title" bind-text="ref('fTitle')" xid="span25"></span></div> 
    <div xid="div12">
     <span xid="span29" bind-text="ref('fPrice')" class="price"></span></div> 
    <div xid="div13" class="color-gray">
     <span xid="span24">月销</span>
     <span xid="span26" bind-text="ref('fRecord')"></span>
     <span xid="span27">笔</span>
     <span xid="span28" bind-text="ref('fPostage')" class="margin-left"></span>
  </div> </div> </div></li></ul> </div>
  </div>
   <div class="x-content-center x-pull-up" xid="div7">
    <span class="x-pull-up-label" xid="span16">加载更多...</span></div> </div>
  </div>  
    </div> 
</div>
