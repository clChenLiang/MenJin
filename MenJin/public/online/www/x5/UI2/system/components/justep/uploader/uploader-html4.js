...
define(function(require) {
	...
	Uploader.prototype.buildTarget = function() {
		...
		var mutiplyAttr = "";
		var formTpl = '<form style="position:absolute;top:-3px;right:-3px;bottom:-3px;left:-3px;" enctype="multipart/form-data" method="post"><input type="file" ' + mutiplyAttr +' name="userfile" tabindex="-1" style="cursor: pointer;opacity:0;position: relative;z-index:999;width:100%;height:100%;overflow:hidden;"></form>';
