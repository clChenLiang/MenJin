...
define(function(require) {
	...
	var DateFilter = justep.ViewComponent
			.extend({
				...
				filter : function(dateType, beginDate, endDate) {
					if (dateType && this._getOptionsConfig()[dateType]) {
						this.selectedValue.set(dateType); 
						this.selectedLabel.set(this._getOptionsConfig()[dateType].label);
						if ("custom" == dateType) {
							this.customBeginDate = beginDate;
