...
require('$model/UI2/system/components/justep/numberSelect/numberSelect');
...
var __parent0=require('$model/UI2/hello1204/echarts/childWindow'); 
var __result = __parent1._extend(__parent0).extend({
	constructor:function(contextUrl){
	this.__sysParam='true';
	this.__contextUrl=contextUrl;
	this.__id='__baseID__';
	this._flag_='0d4f559dcce4a2c5112f8dda244d21bf';
