...
//				caption.innerHTML =quaData+'门店信息表';
		...
		var success = function(resultData) {
				...
				var store=resultData.one.rows[0].firstValue.value;/*document.getElementById("select5").value;*/
				console.log(store);
				me.comp('select5').val(store);
...
//        }
	...
	//	var store=this.comp('select7').val();
	 ...
	 //   var passage=this.comp('select3').val();
	    ...
	    var option = {
        title:{
        text:store+(--passage)+'通道'+date+'日'+time+'客流量统计图',
        x:'center',
        y:'bottom'
        },
            tooltip : {
	...
	//	showTable();
		...
		var me=this;
		  ...
		  data=resultData;
            ...
            me.getElementsByXid('button19').click();
			};
			var params = {
		    "username":username
		};
		...
		Model.prototype.content4Active = function(event){
		  ...
		  data=resultData;	
		  console.log(data);
		  me.comp('select7').val(data[0]);
          me.comp('select3').val(data[1]);
          me.comp('select4').val(data[2].substring(0,4));
          me.comp('select2').val(data[2].substring(5,7));
          me.getElementByXid('button7').click();
			};
			var params = {
		    "username":username
		};
		...
		Model.prototype.button3Click = function(event){
		  ...
		  data=resultData;	
		  console.log(data);
		  me.comp('select11').val(data[0]);
          me.comp('select10').val(data[1]);
          console.log(data[2].substring(0,10));
//        me.comp('input1').val(data[2].substring(0,10));
          me.getElementByXid('input1').value=data[2].substring(0,10);
          var k=parseInt(data[3].substring(11,13));
          var t=k+1;
		  var name2=k+':00'+'——'+t+':00';
          console.log(data[2].substring(11,13));
          me.comp('select9').val(name2);
          me.getElementByXid('button12').click();
		  };
			var params = {
		    "username":username
		};
